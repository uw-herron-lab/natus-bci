...
To utilize processors in this repository, you must add the path to the `natus-bci/processors` folder in the `nw-sdk-realtime/NeuroWorksDataClients/python/zmq-sub.py` script found in the `nw-sdk-realtime` repository.
